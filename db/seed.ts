...
async function seed() {
  ...
  const jobs: Array<[number, string, string, string, string, string, number | null, number | null, string, string, string, number]> = [
    [userId, "Senior Frontend Engineer", "TechCorp", "Sydney, NSW", "Engineering", "Full-time", 150000, 200000, "We're looking for a Senior Frontend Engineer to lead our UI team. You'll architect and build complex web applications using React and TypeScript.\n\nYou'll work closely with designers and backend engineers to deliver exceptional user experiences. Our tech stack includes Next.js, TypeScript, and Tailwind CSS.", "5+ years of frontend development experience\nExpert in React and TypeScript\nExperience with Next.js\nStrong CSS/Tailwind skills\nExperience leading technical projects", "https://example.com/apply", 1],
    [userId, "Product Designer", "DesignStudio", "Remote (Australia)", "Design", "Full-time", 120000, 160000, "Join our design team to create beautiful, intuitive interfaces for our SaaS platform. You'll own the design process from research to final implementation.", "4+ years of product design experience\nProficiency in Figma\nExperience with design systems\nStrong portfolio", "https://example.com/apply", 1],
    [userId, "Marketing Manager", "GrowthCo", "Melbourne, VIC", "Marketing", "Full-time", 90000, 130000, "Lead our marketing efforts and drive growth across all channels. You'll develop and execute marketing strategies.", "3+ years of marketing experience\nExperience with digital marketing channels\nStrong analytical skills", "https://example.com/apply", 0],
    [userId, "Data Analyst", "DataDriven", "Brisbane, QLD", "Data Science", "Part-time", 40000, 60000, "We need a part-time Data Analyst to help us make sense of our growing datasets. You'll create dashboards and run analyses.", "2+ years of data analysis experience\nProficiency in SQL and Python\nExperience with visualization tools", "https://example.com/apply", 0],
    [userId, "DevOps Engineer", "CloudScale", "Perth, WA", "DevOps", "Remote (Australia)", 140000, 180000, "Join our infrastructure team to build and maintain our cloud platform. You'll work on CI/CD pipelines, container orchestration, and monitoring systems.", "4+ years of DevOps/SRE experience\nStrong AWS or GCP experience\nKubernetes and Docker expertise\nExperience with Terraform", "https://example.com/apply", 1],
    [userId, "Junior Software Developer", "StartupXYZ", "Adelaide, SA", "Engineering", "Full-time", 70000, 95000, "Great opportunity for a junior developer to grow their skills in a fast-paced startup environment. You'll work on full-stack features using modern web technologies.", "1+ years of programming experience\nFamiliarity with JavaScript/TypeScript\nBasic understanding of databases\nEager to learn and grow", "https://example.com/apply", 0],
    [userId, "Sales Representative", "SalesForce Inc", "Sydney, NSW", "Sales", "Full-time", 60000, 90000, "Drive revenue growth by building relationships with enterprise clients. You'll manage the full sales cycle from prospecting to closing.", "2+ years of B2B sales experience\nExcellent communication skills\nCRM experience (Salesforce preferred)\nSelf-motivated and goal-oriented", "https://example.com/apply", 0],
    [userId, "UX Researcher", "UserFirst", "Canberra, ACT", "Design", "Contract", 80000, 110000, "6-month contract to lead UX research for our product redesign. You'll plan and conduct user studies, synthesize findings, and drive design decisions.", "3+ years of UX research experience\nExperience with qualitative and quantitative methods\nStrong presentation skills", "https://example.com/apply", 0],
    [userId, "Customer Support Lead", "HelpDesk Pro", "Sydney, NSW", "Customer Support", "Full-time", 55000, 75000, "Lead our customer support team and ensure exceptional service delivery. You'll manage a team of 5 support agents.", "3+ years of customer support experience\n1+ years in a leadership role\nExperience with helpdesk software\nExcellent problem-solving skills", "https://example.com/apply", 0],
    [userId, "Financial Analyst", "FinCorp", "Melbourne, VIC", "Finance", "Full-time", 85000, 120000, "Analyze financial data and create models to support strategic decision-making. You'll work with the CFO and leadership team.", "2+ years of financial analysis experience\nAdvanced Excel and financial modeling skills\nExperience with ERP systems\nCFA or MBA preferred", "https://example.com/apply", 0],
    [userId, "Backend Engineer (Python)", "APIWorks", "Remote (Australia)", "Engineering", "Full-time", 130000, 175000, "Build scalable APIs and microservices using Python and FastAPI. You'll design systems that handle millions of requests per day.", "4+ years of Python backend development\nExperience with FastAPI or Django\nDatabase design (PostgreSQL, Redis)\nAPI design and documentation", "https://example.com/apply", 1],
    [userId, "HR Coordinator", "PeopleFirst", "Melbourne, VIC", "Human Resources", "Full-time", 50000, 70000, "Support our HR operations including onboarding, benefits administration, and employee relations.", "1+ years of HR or administrative experience\nFamiliarity with HR software\nExcellent organizational skills\nStrong interpersonal skills", "https://example.com/apply", 0],
    [userId, "Content Marketing Specialist", "ContentKing", "Remote (Australia)", "Marketing", "Part-time", 45000, 65000, "Create compelling content that drives organic traffic and engagement. You'll write blog posts, case studies, and social media content.", "2+ years of content writing experience\nSEO knowledge\nExperience with CMS platforms\nStrong research skills", "https://example.com/apply", 0],
    [userId, "Product Manager", "InnovateTech", "Sydney, NSW", "Product", "Full-time", 140000, 190000, "Define product strategy and roadmap for our flagship SaaS product. You'll work at the intersection of business, technology, and design.", "5+ years of product management experience\nTechnical background preferred\nExperience with agile methodologies\nStrong data analysis skills", "https://example.com/apply", 1],
    [userId, "Machine Learning Engineer", "AI Solutions", "Perth, WA", "Data Science", "Full-time", 160000, 220000, "Build and deploy ML models that power our AI-driven products. You'll work on NLP, computer vision, and recommendation systems.", "3+ years of ML engineering experience\nPython, PyTorch/TensorFlow\nExperience deploying models to production\nStrong math/statistics foundation", "https://example.com/apply", 1],
    [userId, "React Native Developer", "MobileApps Co", "Adelaide, SA", "Engineering", "Contract", 100000, 140000, "Build cross-platform mobile apps using React Native. 6-month contract with potential for extension.", "3+ years of React Native experience\niOS and Android development knowledge\nExperience with app store deployment\nStrong JavaScript/TypeScript skills", "https://example.com/apply", 0],
    [userId, "Growth Marketing Intern", "LaunchPad", "Remote (Australia)", "Marketing", "Internship", null, null, "Learn growth marketing from experienced mentors. You'll get hands-on experience with paid ads, email marketing, and analytics.", "Currently enrolled in college\nInterest in digital marketing\nBasic understanding of social media\nEager to learn", "https://example.com/apply", 0],
    [userId, "Site Reliability Engineer", "Uptime Inc", "Brisbane, QLD", "DevOps", "Full-time", 135000, 170000, "Keep our systems running at 99.99% uptime. You'll build monitoring, alerting, and auto-remediation systems.", "4+ years of SRE/DevOps experience\nLinux systems administration\nPrometheus/Grafana experience\nIncident management experience", "https://example.com/apply", 0],
  ];
